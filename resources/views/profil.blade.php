    ...
    <div></div>
        ...
        <div class="site-section mt-5">
            <div class="row mb-5 justify-content-center text-center">
                ...
                <span>PROFIL PERPUSTAKAAN STHG</span>
                </h2>
                <p style="text-align: justify">Di jantung kota yang penuh kecerdasan dan semangat belajar, 
                terletak sebuah institusi pengetahuan yang melampaui sekadar penyimpanan buku. 
                Selamat datang di Perpustakaan STHG, singkatan dari "Sumber Tertinggi Hikmat dan Gelar." 
                Perpustakaan ini tidak hanya menjadi tempat untuk mengejar pengetahuan, tetapi juga menawarkan suatu pengalaman intelektual yang mendalam dan memberdayakan.</p>
                </div>
            </div>
        </div>
